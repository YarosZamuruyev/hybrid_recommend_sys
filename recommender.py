...
class Recommender(object):
    def __init__(self):
        self.classifier = joblib.load("./joblib/rf_classifier.joblib")
        self.user_history = joblib.load('./joblib/read_history_dict.joblib')
        self.most_popular_books = joblib.load('./joblib/most_popular_book.joblib')
        self.als_model = joblib.load('./joblib/als_model.joblib')
        self.matrix = joblib.load('./joblib/user_item_matrix.joblib')
        self.books_index = joblib.load('./joblib/books_index.joblib')
        self.user_index = joblib.load('./joblib/user_index.joblib')
        self.books_profile = joblib.load('./joblib/books_profile.pkl') 
        self.users_profile = joblib.load('./joblib/users_profiles.pkl')
        self.cols_for_using = joblib.load('./joblib/cols_for_using.joblib')
    ...
    def get_hybrid_recommendations(self, user_id, usr_ind):
        ...
        for ind in als_recs: 
            if self.books_index[ind] not in already_seen: 
                ...
                user_feat = self.users_profile.loc[[self.user_index[usr_ind]]]
